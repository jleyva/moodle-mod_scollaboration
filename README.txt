...
Rename the scollaboration folder into a lower case name of your module. Make sure
...
instances of string "scollaboration" to your new module name (eg "widget").
   
Rename the file lang/en_utf8/scollaboration.php to widget.php or whatever your
module name is.
...
should find that this scollaboration has been added to the list of recognized
modules.  
...
Credits for work on this scollaboration template
-------------------------------------------
