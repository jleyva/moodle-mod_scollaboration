...
function PaintWeb (win, doc) {
  ...
  this.layerUpdate = function () {
    ...
    SC.components.whiteboard.paintwebUpdated(this.buffer.canvas.toDataURL('image/png'));
