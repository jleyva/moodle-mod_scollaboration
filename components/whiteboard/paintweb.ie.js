...
pwlib.tools.selection = function (app) {
  ...
  this.preActivate = function () {
    ...
    if(navigator.userAgent.toLowerCase().indexOf('msie') != -1) G_vmlCanvasManager.initElement(self.canvas);
    if (!sel.canvas) {
      alert(lang.errorToolActivate);
      return false;
    }
...
function PaintWeb (win, doc) {
  ...
  this.init = function (handler) {
    ...
    if(navigator.userAgent.toLowerCase().indexOf('msie') != -1) G_vmlCanvasManager.initElement(testcanvas);
  ...
  this.initCanvas = function () {
    ...
    if(navigator.userAgent.toLowerCase().indexOf('msie') != -1) G_vmlCanvasManager.initElement(layerCanvas);
    if(navigator.userAgent.toLowerCase().indexOf('msie') != -1) G_vmlCanvasManager.initElement(bufferCanvas);    
    ...
    if (!resInfo) {
      ...
      style.type = 'text/css';
      if(style.styleSheet)
        style.styleSheet.cssText = res.cssText;
      else
    ...
    var events = ['dblclick', 'click', 'mousedown', 'mouseup', 'mousemove', 
      ...
      if (bufferCanvas.addEventListener){  
        for (var i = 0; i < n; i++) {
        ...
        var trackmid = false;
        bufferCanvas.onselectstart = function () {bufferCanvas.onmousemove();trackstart = true;return false;}
        bufferCanvas.onclick = function () {trackend = true;}
        bufferCanvas.onmousemove = function () {
  ...
  this.streamingLayerUpdate = function(){
	var Myimg = new Image();
	
	var layer = this.layer;
	Myimg.onload = function(){
		layer.context.drawImage(Myimg, 0, 0);			
	}
	 Myimg.src = 'http://localhost/moodle20/pix/i/email.gif';
  }
  ...
  this.historyGoto = function (pos) {
    ...
    try {
      ...
      if(navigator.userAgent.toLowerCase().indexOf('msie') != -1) G_vmlCanvasManager.initElement(tmp);
  ...
  this.imageSave = function (type) {
    ...
    if (type !== 'image/png') {
      ...
      if(navigator.userAgent.toLowerCase().indexOf('msie') != -1) G_vmlCanvasManager.initElement(canvas);
